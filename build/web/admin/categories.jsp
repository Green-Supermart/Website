<%-- 
    Document   : categories
    Created on : 16 Dec 2023, 03:37:30
    Author     : Sandun
--%>
...
<html>
    <head>
        ...
        <title>Categories - Admin | GREEN Supermart</title>
                        ...
                        <div class="pageTopic flex">
                            <div class="pageTopicContainer flex flexRow">
                                ...
                                <span class="flex flexRow" style="gap: 10px;">
                                    <span class="addIcon flex" onclick="window.location.href='categories/new.jsp'" title="New Category">
