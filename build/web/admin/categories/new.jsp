<%-- 
    Document   : new
    Created on : 16 Dec 2023, 03:20:23
    Author     : Sandun
--%>
...
<html>
    <head>
        ...
        <title>New Category | Products - Admin | GREEN Supermart</title>
                        ...
                        <div class="pageTopic flex">
                            <div class="pageTopicContainer flex flexRow">
                                <h1 class="flex flexRow" style="align-items: center; gap: 10px;">
                                    <span class="navigator" onclick="window.location.href='../categories.jsp'">
